...
public class ArraysListProblem extends Thread {

    static CopyOnWriteArrayList<String> courses1 = new CopyOnWriteArrayList<>();
...
//        CopyOnWriteArrayList<String> courses1 = new CopyOnWriteArrayList<>();
        ...
        ArraysListProblem arraysListProblem = new ArraysListProblem();
